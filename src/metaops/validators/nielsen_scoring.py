...
def calculate_nielsen_score(onix_path: Path) -> Dict:
    ...
    try:
        ...
        # Score first product (typical use case)
        product = products[0]
        score_breakdown = {}
        total_score = 0
        missing_elements = []
        ...
        # Calculate sales impact estimate based on Nielsen research
        sales_impact = _estimate_sales_impact(percentage_score)
        ...
        return {
            ...
            "recommendation": _get_scoring_recommendation(percentage_score, missing_elements)
        }
